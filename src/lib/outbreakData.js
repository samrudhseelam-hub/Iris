...
export const DISEASES = [
  ...
  },
  {
    ...
    endemicBase: 0.22,
    regionPriors: {
      "Sub-Saharan Africa": 0.55, "South Asia": 0.60, "Southeast Asia": 0.65,
      "Latin America": 0.50, "North Africa": 0.15, "Middle East": 0.12,
      "East Asia": 0.20, "Europe": 0.02, "North America": 0.02,
      "Oceania": 0.18, "Central Asia": 0.05,
    },
    climateSensitivity: 0.80,
    rainfallSensitivity: 0.72,
    densitySensitivity: 0.42,
    infrastructureSensitivity: 0.38,
    seasonalPeak: [6, 10],
    trendDirection: 0.010,
    dataDensity: 0.58,
  },
  {
    name: "Leptospirosis",
